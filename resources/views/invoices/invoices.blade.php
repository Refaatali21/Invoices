					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
                                ...
                                @can('تصدير EXCEL')
                        <a href="{{ url('invoices/export')}}"  class="modal-effect btn btn-sm btn-primary"
									...
									<table id="example1" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											...
											<tr>
												...
												<td>
                                                <a href="{{ url('InvoicesDetils')}}/{{$invoices->id}}">
                                                ...
                                                @can('تعديل الفاتورة')
                                                        <a class="dropdown-item"
                                                            ...
                                                            @can('تغير حالة الدفع')
                                                        <a class="dropdown-item"
                                                            href="{{ URL('Status_show', [$invoices->id]) }}"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ url('invoices/trached') }}" method="post">
                        {{ method_field('post') }}
                        {{ csrf_field() }}
                </div>
                <div class="modal-body">
