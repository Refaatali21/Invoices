                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">SQUARE</h1>
                            <div class="billed-from">
                                <h6>Refaat Ali.</h6>
                                <p>201  St., Helwan, YT 242, Country 6546<br>
                                    Tel No: 01113670401<br>
                                    Email: refaatali778@gmail.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    ...
                                    <p>
                                        Tel No: {{$invoices->number}}<br>
                                        Email: {{$invoices->email}}</p>
                                </div>
                            </div>
                            <div class="col-md">
                        ...
                        <button class="btn btn-purple float-left mt-3 mr-2" id="print_Button" href="#">
						<i class="mdi mdi-currency-usd ml-1"></i>Pay Now</button>

						<button href="#" class="btn btn-success float-left mt-3" id="print_Button">
						<i class="mdi mdi-telegram ml-1"></i>Send Invoice</button>
