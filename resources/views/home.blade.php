                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <h3>
                                <p class="mb-0 tx-12 text-white op-7"> اجمالي الفواتير:({{ \App\Models\invoices::count() }})</p>
                                </h3>
                            </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <h3>
                                <p class="mb-0 tx-12 text-white op-7"> عدد الفواتير الغير مدفوعة:({{ \App\Models\invoices::where('Value_Status', 2)->count() }})
                                </p>
                                </h3>
                            </div>
                            <span class="float-right my-auto mr-auto">
