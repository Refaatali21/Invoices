<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/images.png')}}" class="main-logo" alt="logo"></a>
				...
				<ul class="side-menu">
					...
					<li class="slide">
                        ...
                        @can('قائمة الفواتير')
                            ...
                            @endcan
                            @can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . ($page  = 'invoices_Archives')) }}">أرشفة الفواتير</a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                        @can('تقرير الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='invoices_report') }}">التقارير الفواتير</a></li>
                            @endcan
                            @can('تقرير العملاء')
